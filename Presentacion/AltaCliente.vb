...
Public Class AltaCliente
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        ElseIf Utilidades.ExisteCliente(DniTextBox.Text) Then
        ...
        Else
            ...
            Dim DNI As Integer = DniTextBox.Text
            Dim Telefono As String = TelefonoTextBox.Text
            Dim Celular As String = CelularTextBox.Text
            Dim FechaNacimiento As Date = NacimientoTextBox.Text
            ...
            _Cliente._DNI = DniTextBox.Text
            _Cliente._Telefono = TelefonoTextBox.Text
            _Cliente._Celular = CelularTextBox.Text
            _Cliente._FechaNacimiento = NacimientoTextBox.Text
            _Cliente._Localidad = LocalidadTextBox.Text
            _Cliente._Provincia = ProvinciaTextBox.Text
            _Cliente._IdObraSocial = ObraSocialTextBox.Text

            If Utilidades.AgregarCliente(_Cliente) Then
